...
## SOLUCIÓN
Una vez descargado el archivo, le aplicamos un ctrl+f y ponemos que busque "{}", con ello por el formato que tiene la flag, podemos encontrarla y solamente le aplicamos un ROT13 para descifrarla
